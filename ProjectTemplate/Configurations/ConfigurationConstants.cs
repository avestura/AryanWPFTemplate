...
namespace ProjectTemplate.Configurations
{
    public partial class Configuration
    {
        ...
        /// </summary>
        private static string DirectoryAddress = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "//Aryan Software//$safeprojectname$//";
